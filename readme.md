...
5. Navigate to https://${DOMAIN} in your browser. A prompt to select the imported certificate will appear, assuming the certificates from step 2 were installed in the OS trust store.
